...
class TagCreatorController:
    ...
    def create(self, product_code: str) -> Dict: # 'self' indicates this method is inside of the class context above.
        path_from_tag = self.__create_tag(product_code)
        formatted_response = self.__format_response(path_from_tag)
        return formatted_response

    def __create_tag(self, product_code: str) -> str:  # '__' before the name of the method, indicates that it is a private method.
